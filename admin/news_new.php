          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Latest News</h4>
                <div class="row">
                  <form class="col s12">
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="input-field col s6">
                        <input id="first_name" type="text">
                        <label for="first_name">Source Url</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="first_name" type="text">
                        <label for="first_name">Created From</label>
                      </div>
                      <div class="input-field col s6">
                        <input id="first_name" type="text">
		     ...
		     <div class="row">
                      <div class="input-field col s6">
                        ...
                        <label for="dob">Created Date</label>
                      </div>
                    </div>
                      <div class="row">
                        <div class="input-field col s12">
