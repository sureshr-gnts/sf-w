...
$formd_title="";
$formd_content="";
if(isset($_SESSION["getEdit_formData"])){
        //print_r($_SESSION["newsEdit_formData"]);
		$formd_title=$_SESSION["getEdit_formData"]["title"];
        $formd_content=$_SESSION["getEdit_formData"]["content"];
        unset($_SESSION["getEdit_formData"]);
    }
    unset($_SESSION["getEdit_formData"]);
?>
<html>
