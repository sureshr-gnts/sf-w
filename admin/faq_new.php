...
$formd_title="";
$formd_content="";
if(isset($_SESSION["faqEdit_formData"])){
        //print_r($_SESSION["newsEdit_formData"]);
		$formd_title=$_SESSION["faqEdit_formData"]["title"];
        $formd_content=$_SESSION["faqEdit_formData"]["content"];
        unset($_SESSION["faqEdit_formData"]);
    }
    unset($_SESSION["faqEdit_formData"]);
?>
<html>
