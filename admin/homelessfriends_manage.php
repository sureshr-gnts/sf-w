            	...
            	<div class="row">
              	<div class="col s12 m12 l12">
                	...
                	<ol class="breadcrumb">
                  	...
                  	<li class="active">Homeless Friends</a>
                  	</li>
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 class="header">Homeless Friends</h4>
              <div class="row">
                <div class="col s12 m8 l11">
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            <td>Dogs</td>
                            <td>http://voiceforanimals.info/Vacancies.html</td>
                            <th><img src="images/1.jpg" alt="Scan Foundation" border=3 height=100 width=100></img></th>
			    <td><a href="#">Update|<a href="#">Delete</td>
