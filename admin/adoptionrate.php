            	...
            	<div class="row">
              	<div class="col s12 m12 l12">
                	...
                	<ol class="breadcrumb">
                  	...
                  	<li class="active">Adoption Rate</a>
                  	</li>
                	</ol>
              	</div>
            	</div>
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Adoption Rate</h4>
                <div class="row">
                  <form class="col s12">
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="dog_name" type="text">
                        <label for="dog_name">Number of Lives Rescued</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="area" type="text">
                        <label for="area">Number of Places</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="place" type="text">
                        <label for="place">Number of lives Adopted</label>
                      </div>
                    </div>
