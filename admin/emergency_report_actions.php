...
if($mode == "upload")
{
    ...
    $_SESSION["emergency_reportEdit_formData"]=$_REQUEST;
                     
	

	        global $database, $db;
			$qry_update="INSERT INTO `".TBL_EMERGENCY_REPORT."` (`title`,`content`,`created_from`,`created_by`,`created_dt`)"
                        . " VALUES ('".$title."','".$content."','".$_SERVER['HTTP_USER_AGENT']."','".$_SESSION['VFA_Userid']."', NOW());";
	//print_r($qry_update);
	//exit();
                  ...
                  if($result_upload >0)
	{
		...
		redirect_to('emergency_report_manage.php');;
	}
	else
	{
		$error="Updating failed!.";
		redirect_to('emergency_report_new.php');
	}
