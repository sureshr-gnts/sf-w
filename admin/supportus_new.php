...
$formd_title="";
$formd_content="";
if(isset($_SESSION["supportusEdit_formData"])){
        //print_r($_SESSION["newsEdit_formData"]);
		$formd_title=$_SESSION["supportusEdit_formData"]["title"];
        $formd_content=$_SESSION["supportusEdit_formData"]["content"];
        unset($_SESSION["supportusEdit_formData"]);
    }
    unset($_SESSION["supportusEdit_formData"]);
?>
<html>
